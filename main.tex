...
\begin{itemize}
  \item 设计并实现基于\textbf{SCARA 机械臂与四麦轮（全向轮）底盘小车}的自动化集成系统，完成操作机构与移动平台协同工作。
...
\begin{itemize}
  ...
  \item 项目详情见\ huaqliu.github.io/research
\end{itemize}
...
\begin{itemize}
  \item \textbf{国家奖学金}(专业排名前 3\%)、\textbf{一等安雅奖学金}（综测第一）、\textbf{一等人民奖学金}（学分绩前3\%）、\textbf{校级优秀学生}、\textbf{优秀团员}等
\end{itemize}
